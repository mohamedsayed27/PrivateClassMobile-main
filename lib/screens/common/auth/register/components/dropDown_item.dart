...
class DropDownItem extends StatelessWidget {
  ...
  DropDownItem({Key? key, required this.hint,this.dropDownValue, required this.onChanged, required this.items});
    ...
    return DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Padding(
          ...
          child: Image.asset(AppImages.grayNote,width: width(context)*0.02)),
      ),
