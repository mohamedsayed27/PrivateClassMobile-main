...
class TodayNotification extends StatelessWidget {
  const TodayNotification({Key? key}) : super(key: key);
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        cubit.getNotificationModel!.data!.day![index].type == "group"
                            ? cubit.onClick(
                                id: cubit.getNotificationModel!.data!.day![index].groupId!,
                                context: context,
                                slug: cubit.getNotificationModel!.data!.day![index].groupSlug!)
                            : cubit.getNotificationModel!.data!.day![index].type == "add_phone"
                                ? navigateAndReplace(
                                    context: context,
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Image.network(
                                      cubit.getNotificationModel!.data!
                                          .day![index].icon!,
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: CustomText(
                                            text: cubit.getNotificationModel!
                                                .data!.day![index].body!,
                            ...
                            context.locale.languageCode == "ar"
                                ? Positioned(
                                    ...
                                    child: DeletePopUp(
                                      onTap: () async {
                                        await cubit.deleteNotify(
                                            context: context,
                                            id: cubit.getNotificationModel!
                                                .data!.day![index].id!);
                                      },
                                    ),
                                  )
                  ...
                  itemCount: cubit.getNotificationModel!.data!.day!.length,
                );
        },
